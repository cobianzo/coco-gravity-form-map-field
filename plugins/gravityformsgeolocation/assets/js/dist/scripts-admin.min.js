				...
				var o = gform.utils,
					...
					_ = function () {
						l()(document).on('gform_load_field_settings', d),
							...
							s().addFilter('gform_editor_field_settings', f);
					},
					m = ajaxurl,
					v = n.n(m),
					y = n(4265),
					...
					b = function () {
						var e = document.querySelector('#tab_gravityformsgeolocation #gform-settings-save');
						e && e.addEventListener('click', h, !0),
					...
					O = google,
					j = n.n(O),
					S = { mapRoot: (0, o.getNodes)('geolocation-map-root')[0] },
					F = function () {
						S.mapRoot &&
							(!(function () {
								var e = parseFloat(S.mapRoot.dataset.lat),
									t = parseFloat(S.mapRoot.dataset.long),
									n = new (j().maps.Map)(S.mapRoot, { center: { lat: e, lng: t }, zoom: 8 });
								new (j().maps.Marker)({ position: { lat: e, lng: t }, map: n });
							})(),
