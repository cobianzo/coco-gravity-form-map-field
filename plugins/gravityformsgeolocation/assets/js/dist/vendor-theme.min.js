...
(self.webpackChunkgravityformsgeolocation = self.webpackChunkgravityformsgeolocation || []).push([
	[499],
	{
		...
		3895: function (t, n, r) {
			var e = r(5468).IteratorPrototype,
				o = r(6082),
				i = r(7547),
				u = r(9732),
				c = r(5794),
		...
		15: function (t, n, r) {
			var e = r(2204),
				o = r(6923).concat('length', 'prototype');
			n.f =
			...
			t.exports = a(
				...
				function () {
					var t = y(this),
						n = t.target,
						r = t.index++;
					if (!n || r >= n.length) return (t.target = void 0), f(void 0, !0);
					switch (t.kind) {
						case 'keys':
							return f(r, !1);
						case 'values':
